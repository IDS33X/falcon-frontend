...
export const fetchAreasBySearch = (searchQuery) => API.get(`/Area/SearchAreas?Filter=${searchQuery.search || 'none'}&ItemsPerPage=${searchQuery.itemsPerPage}`);
...
export const fetchDivisionsBySearch = (searchQuery) => API.get(`/Division/SearchDivisionsByArea?AreaId=${searchQuery.areaId}&Filter=${searchQuery.search || 'none'}&ItemsPerPage=${searchQuery.itemsPerPage}`);
...
export const fetchDepartmentsBySearch = (searchQuery) => API.get(`/Department/SearchDepartmentsByDivision?DivisionId=${searchQuery.divisionId}&Filter=${searchQuery.search || 'none'}&ItemsPerPage=${searchQuery.itemsPerPage}`);
...
export const fetchRiskCategoriesBySearch = (searchQuery) => API.get(`/RiskCategory/GetSearchRiskCategoriesByDepartment?DepartmentId=${searchQuery.departmentId}&Filter=${searchQuery.search || 'none'}&ItemsPerPage=${searchQuery.itemsPerPage}`);
